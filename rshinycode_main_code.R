                           ...
                           fluidPage(
                                   sidebarLayout(
                                       sidebarPanel( 
                                        ...
                                        actionButton("plotclick_sb","Plot"))
                         ...
                         fluidPage(useShinyjs(),
                                   sidebarLayout(
                                     sidebarPanel(
                                       ...
                                       wellPanel(actionButton("plotclick_spat","Plot"))
                                     ),#End Sidebarpanel
...
#########Statistical Tab Server Side Start#################
  ...
  observeEvent(c(input$plotclick,input$plotclick_sb), {
...
######Spatial Tab Server Side Start###############
   ...
   observeEvent(c(input$spatplotclick, input$plotclick_spat),{
